...
// TODO Auto-generated method stub
    ...
    public List<ServiciosExtra> listCaracteristicas(String idHospedaje) {
        ...
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT * FROM serviciosextra WHERE IDHOSPEDAJE = '").append(idHospedaje);  //construye la cadena de consulta
        sql.append("'");
        ...
        try{
            ...
            while (rs.next()){  //mientras haya registros en la tabla
                ServiciosExtra ServiciosExtra = new ServiciosExtra();
                ServiciosExtra.setDescripcion(rs.getString("DESCRIPCION"));
                ServiciosExtra.setIdServiciosExtra(rs.getInt("IDSERVICIOSEXTRA"));
                list.add(ServiciosExtra);  //añade el objeto temporal en la lista
            }
        } catch (Exception e) {
    ...
    public int ServiciosSitio(String idHospedaje) {
        ...
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT * FROM serviciosextra WHERE IDHOSPEDAJE = '").append(idHospedaje);
        sql.append("'");
